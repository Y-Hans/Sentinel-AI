...
def main():
    ...
    mlp_large = MLPClassifier(hidden_layer_sizes=(128, 64), max_iter=300, random_state=42, early_stopping=True)
    evaluate_model("MLP (128, 64)", mlp_large)
    
    # Test HistGBM
    gbm = HistGradientBoostingClassifier(random_state=42, max_depth=5, max_iter=200)
    evaluate_model("HistGBM", gbm)
